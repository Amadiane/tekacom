...
const Signupleft = () => {
  return (
    ...
    <Logininput type="text" label = "enter  your FullName" placeholder = "enter your full name" />

    <Logininput type="text" label = "enter  your username" placeholder = "enter your username" />
    <Logininput type="email" label = "enter  your email address" placeholder = "enter your email" />
    <Logininput type="date" label = "enter  your dateofBirth" placeholder = "enter your dateofBirth" />
    <Logininput type="password" label = "enter  your Password" placeholder = "enter your password" />
    
     
     <Loginbutton text="Sign up" className="w-full block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded-lg
